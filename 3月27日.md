...
| 迁移方向         | MR   | FFT  | Δ = FFT - MR | 分析                              |
| ---------------- | ---- | ---- | ------------ | --------------------------------- |
| Real → quickdraw | 77.0 | 87.9 | **+10.9**    | FFT 明显更强（数据分布差大）      |
| Real → sketch    | 41.2 | 50.6 | **+9.4**     | sketch 风格较弱，FFT 稍强         |
| Real → clipart   | 47.8 | 62.1 | **+14.3**    | clipart → real 差异中等，FFT 占优 |
| Real → infograph | 31.1 | 42.5 | **+11.4**    | infograph 最难迁移，MR 效果差     |
